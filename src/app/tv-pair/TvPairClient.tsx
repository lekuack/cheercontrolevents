  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-4 md:p-8 font-sans">
      <div className="space-y-8 max-w-5xl mx-auto">
        {/* Encabezado */}
        <div className="glass-panel p-6 border-l-4 border-l-purple-500 rounded-2xl bg-slate-900/80 border border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-xl">
          <div>
        ...
        {/* Input de PIN */}
        <div className="glass-panel p-6 border border-white/10 rounded-2xl space-y-4 bg-slate-900/80 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          {events.length === 0 ? (
            <div className="glass-panel p-8 text-center text-gray-400 space-y-3 border border-white/10 rounded-2xl bg-slate-900/80">
              <p className="text-sm font-semibold">No se encontraron eventos activos.</p>
              <p className="text-xs text-gray-500">Crea un evento primero en el sistema.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {events.map((evt) => {
                ...
                return (
                  <div
                    key={evt.id}
                    className={`glass-panel p-5 rounded-2xl border transition-all space-y-4 flex flex-col justify-between bg-slate-900/80 ${
                      isSelected
